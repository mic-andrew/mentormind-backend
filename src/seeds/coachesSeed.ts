...
When starting a session, ask about their biggest productivity challenge right now and what they've already tried.`,
    tone: 'direct',
    methodology:
      'Peak Performance Protocol combining cognitive science with practical time management',
    sampleTopics: [
      {
        id: '1',
        icon: 'time-outline',
        title: 'Morning Routines',
        description: 'Design the perfect first hour to win your entire day.',
      },
      {
        id: '2',
        icon: 'bulb-outline',
        title: 'Deep Work Strategy',
        description: 'Eliminate distractions and achieve flow state on demand.',
      },
      {
        id: '3',
        icon: 'mail-outline',
        title: 'Inbox Zero',
        description: 'Systems to manage communication overload effectively.',
      },
    ],
    ...
    sampleTopics: [
      {
        ...
        description: 'Create personalized routines that fit your lifestyle.',
      },
      {
        id: '2',
        icon: 'trending-up-outline',
        title: 'Progress Tracking',
        description: 'Monitor and celebrate your fitness journey.',
      },
      {
        id: '3',
        icon: 'restaurant-outline',
        title: 'Nutrition Basics',
        description: 'Simple eating strategies for better performance.',
      },
    ],
    conversationStarters: [
...
When starting a session, ask about their current financial priority or challenge.`,
    ...
    sampleTopics: [
      ...
      },
      {
        ...
        description: 'Maximize savings without sacrificing quality of life.',
      },
      {
        id: '3',
...
When starting a session, ask what leadership challenge is top of mind for them today.`,
    tone: 'warm',
    methodology:
      'Authentic Leadership Development focusing on self-awareness and emotional intelligence',
    sampleTopics: [
      {
        id: '1',
        icon: 'people-outline',
      ...
      },
      {
        ...
        description: 'Strategic planning for your next big move.',
      },
    ],
    conversationStarters: [
...
When starting a session, gently ask how they're feeling and what brought them here today.`,
    tone: 'warm',
    methodology:
      'Mindful Presence Protocol combining breath work, awareness, and cognitive reframing',
    sampleTopics: [
      {
        id: '1',
        icon: 'leaf-outline',
      ...
      },
      {
        ...
        icon: 'moon-outline',
        title: 'Better Sleep',
        description: 'Wind-down routines for restful nights.',
      },
    ],
    conversationStarters: [
    ...
    sampleTopics: [
      {
        ...
        description: 'Proven models for sustainable business growth.',
      },
      {
        id: '2',
      ...
      },
      {
        ...
        description: 'Improve conversion at every stage.',
      },
    ],
    conversationStarters: [
    ...
    sampleTopics: [
      {
        ...
        description: 'Strategies for deeper, more restful sleep.',
      },
      {
        id: '2',
        icon: 'nutrition-outline',
        title: 'Nutrition Basics',
        description: 'Sustainable eating habits for lasting energy.',
      },
      {
        id: '3',
        icon: 'fitness-outline',
        title: 'Movement & Energy',
        description: 'Finding exercise you actually enjoy.',
      },
    ],
    conversationStarters: [
    ...
    sampleTopics: [
      {
        ...
        description: 'Clarify your direction and competitive advantage.',
      },
      {
        id: '2',
        icon: 'git-branch-outline',
        title: 'Decision Making',
        description: 'Navigate complex business decisions with clarity.',
      },
      {
        id: '3',
        icon: 'layers-outline',
